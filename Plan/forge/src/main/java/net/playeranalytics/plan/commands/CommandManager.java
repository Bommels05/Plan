...
public class CommandManager {
    ...
    public CommandManager(CommandDispatcher<CommandSourceStack> dispatcher, ErrorLogger errorLogger) {
    ...
    private int execute(CommandContext<CommandSourceStack> ctx, Subcommand subcommand) {
        runnableFactory.create(() -> {
            try {
                ...
                ctx.getSource().sendFailure(new TextComponent("An internal error occurred, see the console for details."));
