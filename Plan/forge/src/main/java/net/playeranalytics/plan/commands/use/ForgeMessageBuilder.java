...
public class ForgeMessageBuilder implements MessageBuilder {
    ...
    ForgeMessageBuilder(CommandSourceStack sender, ForgeMessageBuilder previous) {
        this.sender = sender;
        this.builder = new TextComponent("");
    ...
    public MessageBuilder addPart(String s) {
        ...
        newBuilder.builder.append(new TextComponent(s));
        return newBuilder;
    }
    ...
    public MessageBuilder hover(String message) {
        builder.withStyle(style -> style.withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponent(message))));
        return this;
    }

    @Override
    public MessageBuilder hover(String... lines) {
        builder.withStyle(style -> style.withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponent(new TextStringBuilder().appendWithSeparators(lines, "\n").toString()))));
        return this;
    }
